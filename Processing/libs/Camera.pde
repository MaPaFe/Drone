...
class Knct {
  ...
  for (int i = 0; i<temp.pixels.length; i++)
      temp.pixels[i] = int(java.awt.Color.RGBtoHSB((temp.pixels[i] >> 16) & 0xff, (temp.pixels[i] >> 8) & 0xff, temp.pixels[i] & 0xff, null)[2]*7000); //extract normalized brightness values and scale to kinect(7000)
